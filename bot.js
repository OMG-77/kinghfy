...
client.user.setGame(`Light Games`,"https://www.twitch.tv/joker7rl")
client.user.setStatus("joker")
});



client.login(NTczNTE2MTAyMzMyNTc5ODgw.XMtjSQ.gVlj6xyGy6Z5Cty3hPy24d19en4);// لا تغير فيها شيء